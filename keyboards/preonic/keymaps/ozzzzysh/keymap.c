...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_ortho_5x12(KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, TD(TD_TAB_ESC), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, KC_GRV, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, TD(TD_QUOT_PIPE), TD(TD_LSFT_CAPS), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, TD(TD_DOT_SLSH), KC_UP, KC_ENT, KC_LCTL, KC_LALT, MO(3), KC_SPC, KC_SPC, KC_SPC, KC_SPC, MO(4), DF(1), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [5] = LAYOUT_ortho_5x12(KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_TRNS, RESET, DF(0), DF(1), DF(2), KC_TRNS, KC_TRNS, KC_BTN1, KC_MS_U, KC_BTN2, KC_BTN3, KC_TRNS, KC_TRNS, KC_BTN1, KC_ACL0, KC_ACL1, KC_ACL2, KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, SONG1, SONG2, SONG3, SONG4, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SECRET_4, KC_SECRET_3, KC_SECRET_2, KC_SECRET_1)
};
